...
from .feature_config_without_style import build_input, build_embed_features, build_spare_features, \
...
def user_aware_multi_modal_cross_network(input_config, user_spare_faeture_config, user_dense_faeture_config,
    ...
    if passthrough:
        ...
        item_multi_modal = tf.stack(
            [item_spare_modal_embedding, item_semantics_modal_embedding,
